...
using HJM.Chip8.CPU.Instructions.Chip8.SubInstructions._F;
using System;
    ...
    public class _F000 : Instruction
    {
        ...
        public _F000()
        {
            ...
            var types = AppDomain.CurrentDomain.GetAssemblies()
                ...
                .Where(p => typeof(Instruction).IsAssignableFrom(p) && p.Namespace == "HJM.Chip8.CPU.Instructions.Chip8.SubInstructions._F");
