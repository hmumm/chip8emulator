...
using HJM.Chip8.CPU.Instructions.Chip8.SubInstructions.SubE;
using System;
...
namespace HJM.Chip8.CPU.Instructions.Chip8
{
    ...
    /// </summary>
    public class InsE000 : Instruction
    {
        ...
        public InsE000()
        {
            ...
            IEnumerable<Type>? types = AppDomain.CurrentDomain.GetAssemblies()
                ...
                .Where(p => typeof(Instruction).IsAssignableFrom(p) && p.Namespace == "HJM.Chip8.CPU.Instructions.Chip8.SubInstructions.SubE");
